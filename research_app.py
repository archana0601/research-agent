...
/* Hero */
.hero-wrap { position: relative; padding: 80px 24px 28px; text-align: center; overflow: hidden; }
...
.hero p { font-size: 16px; color: #4a4a5a; line-height: 1.65; margin-bottom: 20px; max-width: 460px; margin-left: auto; margin-right: auto; }
...
/* Features */
.features-wrap { padding: 28px 60px 56px; max-width: 1100px; margin: 0 auto; }
