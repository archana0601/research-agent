...
/* Hero */
.hero-wrap { position: relative; padding: 90px 24px 48px; text-align: center; overflow: hidden; }
...
.hero h1 { font-size: 62px; font-weight: 900; line-height: 1.12; letter-spacing: -2px; margin-bottom: 56px; }
...
.hero p { font-size: 16px; color: #4a4a5a; line-height: 1.65; margin-bottom: 56px; max-width: 460px; margin-left: auto; margin-right: auto; }
...
/* Features */
.features-wrap { padding: 48px 60px 64px; max-width: 1100px; margin: 0 auto; }
