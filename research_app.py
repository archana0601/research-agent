...
/* Hero */
.hero-wrap { position: relative; padding: 90px 24px 40px; text-align: center; overflow: hidden; }
...
/* Features */
.features-wrap { padding: 40px 60px 60px; max-width: 1100px; margin: 0 auto; }
